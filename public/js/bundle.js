...
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
var _default = exports.default = _formData.default;
...
const VERSION = exports.VERSION = "1.2.6";
...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/kapildave6/cm1fxigx3000n01qv74ju6lfs'
  });
};
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51Q5se9F21g7kIW3rvdVqg598tXsnHHbK7wC5xxaEcL2WS781T7nBMjjstB3Ti7fVO9pKMWykopTdoUlo0IrcT1Ni00uOaPJ0jf');
...
var isLoggedOut = document.querySelector('.nav__el--logout');
...
if (isLoggedOut) {
  isLoggedOut.addEventListener('click', _login.logout);
}
if (updateUserForm) {
